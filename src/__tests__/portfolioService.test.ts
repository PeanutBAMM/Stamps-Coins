...
describe('portfolioService', () => {
    ...
    describe('getTotalValue', () => {
        it('should calculate total value correctly', async () => {
            const mockItems = [
                { market_price: 100, manual_price: null },
                { market_price: 50, manual_price: 75 }, // Manual overrides market
                { market_price: null, manual_price: 25 },
            ];
    ...
    describe('get24hChange', () => {
        it('should calculate positive change correctly', async () => {
            ...
            const mockCurrentItems = [{ market_price: 150, manual_price: null }];
