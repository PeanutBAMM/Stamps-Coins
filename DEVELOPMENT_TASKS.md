...
### Supabase Setup
- [ ] **SUP-001** Supabase project aanmaken
- [ ] **SUP-002** Database schema uitvoeren (alle tabellen)
- [ ] **SUP-003** RLS policies configureren voor `profiles`
- [ ] **SUP-004** RLS policies configureren voor `vaults`
- [ ] **SUP-005** RLS policies configureren voor `items`
- [ ] **SUP-006** RLS policies configureren voor `portfolio_history`
- [ ] **SUP-007** Supabase Auth configureren (email/password + anon)
- [ ] **SUP-008** Storage bucket aanmaken voor images

### React Native Project
- [ ] **RN-001** Expo project initialiseren met TypeScript template
- [ ] **RN-002** Supabase client library installeren + configureren
- [ ] **RN-003** Navigation structure opzetten (React Navigation)
- [ ] **RN-004** Basis folder structuur aanmaken (`src/screens`, `src/services`, etc.)
- [ ] **RN-005** Environment variabelen setup (`.env`)
- [ ] **RN-006** ESLint + Prettier configureren
- [ ] **RN-007** Husky pre-commit hooks installeren

### Externe Services
- [ ] **EXT-001** Cloudinary account aanmaken
- [ ] **EXT-002** Cloudinary upload preset configureren (unsigned)
- [ ] **EXT-003** RevenueCat account aanmaken
- [ ] **EXT-004** RevenueCat iOS/Android apps registreren
- [ ] **EXT-005** RevenueCat product configureren (pro_vault_monthly €7,99)
- [ ] **EXT-006** Gemini API key genereren
- [ ] **EXT-007** Sentry project aanmaken

### CI/CD
- [ ] **CI-001** GitHub repository aanmaken
- [ ] **CI-002** GitHub Actions workflow schrijven
- [ ] **CI-003** EAS configureren voor builds
- [ ] **CI-004** Branch protection rules instellen

---

## 🔐 Sprint 1: Authentication & User Management (Week 2-3)

### Auth Services
- [ ] **AUTH-001** `authService.ts` - Anonymous sign-in (Ghost mode)
- [ ] **AUTH-002** `authService.ts` - Email/password registration
- [ ] **AUTH-003** `authService.ts` - Email/password login
- [ ] **AUTH-004** `authService.ts` - Ghost-to-Email conversion
- [ ] **AUTH-005** `authService.ts` - Password reset flow
- [ ] **AUTH-006** `authService.ts` - Session persistence
- [ ] **AUTH-007** `useAuth.ts` hook - Auth state management

### Auth Screens
- [ ] **AUTH-008** `LoginScreen.tsx` - Email input UI
- [ ] **AUTH-009** `LoginScreen.tsx` - Password input UI
- [ ] **AUTH-010** `LoginScreen.tsx` - "Doorgaan zonder account" button
- [ ] **AUTH-011** `RegisterScreen.tsx` - Email validatie
- [ ] **AUTH-012** `RegisterScreen.tsx` - Password requirements
- [ ] **AUTH-013** `RegisterScreen.tsx` - Terms checkbox
- [ ] **AUTH-014** `ForgotPasswordScreen.tsx` - Reset flow
